...
const NavBar = () => {
    ...
    return (
        <nav className="bg-slate-600 p-1">
            ...
            <ul className={`${openMenu ? 'top-[60px]' : 'top-[-300px]'} flex lg:flex-row flex-col lg:justify-center items-end gap-4 lg:gap-10 lg:text-xl  bg-slate-600 p-4 text-white lg:top-0 lg:left-0 left-[75%] lg:w-full absolute duration-500 lg:relative lg:ml-0 w-[25%] `}>
                {
